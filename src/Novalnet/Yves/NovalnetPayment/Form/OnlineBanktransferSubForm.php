...
class OnlineBanktransferSubForm extends AbstractSubForm
{
    protected const PAYMENT_METHOD = 'online-banktransfer';
    ...
    {
        return NovalnetConfig::NOVALNET_PAYMENT_METHOD_ONLINEBANKTRANSFER;
    }
